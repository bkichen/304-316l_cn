...
$(function () {
    ...
    $('#wap_msg_btn').click(function () {
        ...
        var ymz = "@#$%";
        var title = subObj.find("#wap_title").val();
        var name = subObj.find("#wap_name").val();
        var sex = subObj.find("input[name='wap_sex']:checked").val();
        var phone = subObj.find("#wap_phone").val();
        var email = subObj.find("#wap_email").val();
        var objt = subObj.find("input[name='wap_rbl_objt']:checked").val();
        var content = subObj.find("#wap_content").val();
